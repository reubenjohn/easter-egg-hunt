# Invite Message Drafts

[← Back to Phase 09](README.md)

Short text message options to send to players with the site link. Pick one, customize if needed, and fire it off.

## Option A — Classic Hype
...
>
> Full details & your color assignment: https://reubenjohn.github.io/easter-egg-hunt/
>
> — R&R
...
>
> (Spoiler: there are Skittles involved.)
>
> — R&R
...
Run through this before sending the invite to anyone:
...
- [ ] Test on your own phone (tap the link, scroll through all sections)
- [ ] Check at least one other browser (Safari, Firefox, or Edge)
- [ ] Text is readable, images aren't cut off, buttons/links are tappable

### Final Sanity

- [ ] No placeholder text ("Lorem ipsum", "TODO", "TBD") visible anywhere
- [ ] R&R branding present
- [ ] No embarrassing typos in player names or rules
- [ ] Link in the text message actually works (copy-paste it, don't just assume)
